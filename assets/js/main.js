...
if (uiState === undefined) {
    uiState =  1; //Math.floor(Math.random() * 5) + 1;
}
    ...
    switch (uiState) {
        case 1:
            $scope.homeType = function () {
                    return 'vistas/homeTypes/home-es.html';
            } 
            break;
    ...
    switch (uiState) {
        case 1:
            $scope.aboutType = function () {
                    return 'vistas/aboutTypes/about-es.html';
            } 
            break;
    ...
    switch (uiState) {
        case 1:
            $scope.servicesType = function () {
                    return 'vistas/servicesTypes/services-es.html';
            } 
            break;
...
/* =================================================
***** C O N T A C T  C O N T R O L L E R *****
================================================= */ 
myApp.controller('contactController', function ($scope) {
    /* Choose the current uiState */
    switch (uiState) {
        case 1:
            $scope.contactType = function () {
                return 'vistas/contactTypes/contact-es.html';
            } 
            break;
    
        // case 2:
        //     $scope.contactType = function () {
        //         return 'vistas/contactTypes/contacto-na.html';
        //     } 
        //     break;
    
        // case 3:
        //     $scope.contactType = function () {
        //             return 'vistas/contactTypes/contacto-lm.html';
        //     } 
        //     break;
    
        // case 4:
        //     $scope.contactType = function () {
        //             return 'vistas/contactTypes/contacto-ki.html';
        //     } 
        //     break;
                
        // case 5:
        //     $scope.contactType = function () {
        //             return 'vistas/contactTypes/contacto-vs.html';
        //     } 
        //     break;
